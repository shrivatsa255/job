...
const SalaryPage = () => {
  ...
  return (
    <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <PageHeader title={"EstimateSalary"} path={"Salary"}/>
        ...
        {/* salary display card */}
        <div className='grid lg:grid-cos-3 sm:grid-cols-2 grid-cols-1 gap-12 my-12 items-center'>
            {
                salary.map((data) => (
                   ...
                   <div className="flex flex-wrap gap-4">
                    <a href="/home" className='underline'>{data.status}</a>
                    <a href="/home" className='underline'>{data.skills}</a>
                   </div>
                   </div>
                ))
            }
